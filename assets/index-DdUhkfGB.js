 ...
 * limitations under the License.
 * =============================================================================
 */function ow(e,...t){const n=t.map((r,a)=>N(r,`tensors${a}`,"einsum")),s={equation:e};return O.runKernel(Eh,n,s)}const Ys=A({einsum_:ow});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function bw(e,t=null,n=!1){let s=N(e,"x","sum");s.dtype==="bool"&&(s=Zt(s,"int32"));const r={x:s},a={axis:t,keepDims:n};return O.runKernel(kd,r,a)}const jt=A({sum_:bw});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function ww(e,t="euclidean",n=null,s=!1){e=N(e,"x","norm");const r=Np(e,t,n);let a=r.shape;if(s){const o=ae(n,e.shape);a=an(r.shape,o)}return X(r,a)}function Np(e,t,n=null){if(e.rank===0)return Pe(e);if(e.rank!==1&&n===null)return Np(X(e,[-1]),t,n);if(e.rank===1||typeof n=="number"||Array.isArray(n)&&n.length===1){if(t===1)return jt(Pe(e),n);if(t===1/0)return rr(Pe(e),n);if(t===-1/0)return Vi(Pe(e),n);if(t==="euclidean"||t===2)return Ln(jt(ea(Pe(e),At(2,"int32")),n));throw new Error(`Error in norm: invalid ord value: ${t}`)}if(Array.isArray(n)&&n.length===2){if(t===1)return rr(jt(Pe(e),n[0]),n[1]-1);if(t===1/0)return rr(jt(Pe(e),n[1]),n[0]);if(t===-1/0)return Vi(jt(Pe(e),n[1]),n[0]);if(t==="fro"||t==="euclidean")return Ln(jt(Je(e),n));throw new Error(`Error in norm: invalid ord value: ${t}`)}throw new Error(`Error in norm: invalid axis: ${n}`)}const Do=A({norm_:ww});/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function ek(e,t=null,n=!1){const s=N(e,"x","logSumExp"),r=ae(t,s.shape),a=rr(s,r,!0),o=Tt(s,a),i=Rs(o),l=jt(i,r),c=na(l),u=vt(X(a,c.shape),c);if(n){const f=an(u.shape,r);return X(u,f)}return u}const Dp=A({logSumExp_:ek});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function hr(e,t="float32"){if(ze(e),t==="complex64"){const s=hr(e,"float32"),r=hr(e,"float32");return is(s,r)}const n=fe(nt(e),t);return O.makeTensor(n,e,t)}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function qS(e,t=0){const n=N(e,"x","unstack","string_or_numeric");T(t>=-n.shape.length&&t<n.shape.length,()=>`Axis = ${t} is not in [-${n.shape.length}, ${n.shape.length})`);const s={value:n},r={axis:t};return O.runKernel(Pd,s,r)}const Us=A({unstack_:qS});/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Lc(e,t,n){if(n==null||n==="linear")return e;if(n==="relu")return lt(e,jp(t));throw new Error(`Cannot compute gradient for fused activation ${n}.`)}function zc(e,t){let n=t;const s=J1(e.shape,t.shape);return s.length>0&&(n=jt(n,s)),X(n,e.shape)}function Bc(e,t,n,s){if(t==="linear")return e;if(t==="relu")return Po(e);if(t==="elu")return vp(e);if(t==="relu6")return Bp(e);if(t==="prelu")return Lp(e,n);if(t==="leakyrelu")return Ep(e,s);if(t==="sigmoid")return sr(e);throw new Error(`Unknown fused activation ${t}.`)}const Wc=(e,t)=>!(e>0)||t==="linear";/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Vx(e){const t=N(e,"image","RGBToGrayscale"),n=t.rank-1,s=t.shape[n];T(t.rank>=2,()=>`Error in RGBToGrayscale: images must be at least rank 2, but got rank ${t.rank}.`),T(s===3,()=>`Error in RGBToGrayscale: last dimension of an RGB image should be size 3, but got size ${s}.`);const r=t.dtype,a=Zt(t,"float32"),o=Ue([.2989,.587,.114]);let i;switch(t.rank){case 2:i=Ys("ij,j->i",a,o);break;case 3:i=Ys("ijk,k->ij",a,o);break;case 4:i=Ys("ijkl,l->ijk",a,o);break;case 5:i=Ys("ijklm,m->ijkl",a,o);break;case 6:i=Ys("ijklmn,n->ijklm",a,o);break;default:throw new Error("Not a valid tensor rank.")}return i=En(i,-1),Zt(i,r)}const Lx=A({rgbToGrayscale_:Vx});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */var Ne;(function(e){e[e.NONE=0]="NONE",e[e.MEAN=1]="MEAN",e[e.SUM=2]="SUM",e[e.SUM_BY_NONZERO_WEIGHTS=3]="SUM_BY_NONZERO_WEIGHTS"})(Ne||(Ne={}));function vN(e,t,n=Ne.SUM_BY_NONZERO_WEIGHTS){const s=N(e,"losses","computeWeightedLoss");let r=null;t!=null&&(r=N(t,"weights","computeWeightedLoss"));const a=r==null?s:lt(s,r);if(n===Ne.NONE)return a;if(n===Ne.SUM)return jt(a);if(n===Ne.MEAN){if(r==null)return Ja(a);{const o=s.size/r.size,i=Wt(jt(a),jt(r));return o>1?Wt(i,At(o)):i}}if(n===Ne.SUM_BY_NONZERO_WEIGHTS){if(r==null)return Wt(jt(a),At(s.size));{const o=lt(r,$s(s.shape)),i=Zt(jt(Mp(o,At(0))),"float32");return Wt(jt(a),i)}}throw Error(`Unknown reduction: ${n}`)}const Gn=A({computeWeightedLoss_:vN});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class js extends fI{minimize(t,n=!1,s){const{value:r,grads:a}=this.computeGradients(t,s);if(s!=null){const o=s.map(i=>({name:i.name,tensor:a[i.name]}));this.applyGradients(o)}else this.applyGradients(a);return Te(a),n?r:(r.dispose(),null)}get iterations(){return this.iterations_==null&&(this.iterations_=0),this.iterations_}incrementIterations(){this.iterations_=this.iterations+1}computeGradients(t,n){return Gw(t,n)}dispose(){this.iterations_!=null&&Te(this.iterations_)}async saveIterations(){return this.iterations_==null&&(this.iterations_=0),{name:"iter",tensor:At(this.iterations_,"int32")}}async getWeights(){throw new Error("getWeights() is not implemented for this optimizer yet.")}async setWeights(t){throw new Error(`setWeights() is not implemented for this optimizer class ${this.getClassName()}`)}async extractIterations(t){return this.iterations_=(await t[0].tensor.data())[0],t.slice(1)}}Object.defineProperty(js,Symbol.hasInstance,{value:e=>e.minimize!=null&&e.computeGradients!=null&&e.applyGradients!=null});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function T_(e,t,n,s){const[r,a]=qn(e,s),o=Sr(t,"int32"),i=fe(nt(r),o),l=nt(a);for(let c=0;c<i.length;++c){const u=c*l;let f=1;for(let h=0;h<l;++h)f*=n[u+h];i[c]=f}return{outVals:i,outShape:r,outDtype:o}}function $_(e){const{inputs:t,backend:n,attrs:s}=e,{x:r}=t,{axis:a,keepDims:o}=s;ft(r,"prod");const i=r.shape.length,l=ae(a,r.shape),c=Nn(l,i);let u=l,f=r;const h=[];c!=null&&(f=_e({inputs:{x:r},backend:n,attrs:{perm:c}}),h.push(f),u=In(u.length,i));const d=n.data.get(f.dataId).values,{outVals:p,outShape:y,outDtype:g}=T_(f.shape,f.dtype,d,u);let m=y;return o&&(m=an(y,l)),h.forEach(w=>n.disposeIntermediateTensorInfo(w)),n.makeTensorInfo(m,g,p)}const __={kernelName:ad,backendName:"cpu",kernelFunc:$_};/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function EE(e){const{inputs:t,backend:n,attrs:s}=e,{x:r}=t,{axis:a,keepDims:o}=s;ft(r,"all");const i=ae(a,r.shape);let l=i;const c=Nn(l,r.shape.length);let u=r;c!=null&&(u=_e({inputs:{x:r},backend:n,attrs:{perm:c}}),l=In(l.length,r.shape.length)),Hs("all",l,u.shape.length);const[f,h]=qn(u.shape,l),d=nt(h),p=fe(nt(f),u.dtype),y=n.data.get(u.dataId).values;for(let m=0;m<p.length;++m){const w=m*d;let S=y[w];for(let k=0;k<d;++k){const I=y[w+k];S=S&&I}p[m]=S}c!=null&&n.disposeIntermediateTensorInfo(u);const g=n.makeTensorInfo(f,u.dtype,p);if(o){const m=an(f,i),w=Ht({inputs:{x:g},backend:n,attrs:{shape:m}});return n.disposeIntermediateTensorInfo(g),w}return g}const CE={kernelName:eh,backendName:"cpu",kernelFunc:EE};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function AE(e){const{inputs:t,backend:n,attrs:s}=e,{x:r}=t,{axis:a,keepDims:o}=s;ft(r,"any");const i=ae(a,r.shape);let l=i;const c=Nn(l,r.shape.length);let u=r;c!=null&&(u=_e({inputs:{x:r},backend:n,attrs:{perm:c}}),l=In(l.length,r.shape.length)),Hs("any",l,u.shape.length);const[f,h]=qn(u.shape,l),d=nt(h),p=fe(nt(f),u.dtype),y=n.data.get(u.dataId).values;for(let m=0;m<p.length;++m){const w=m*d;let S=y[w];for(let k=0;k<d;++k){const I=y[w+k];S=S||I}p[m]=S}c!=null&&n.disposeIntermediateTensorInfo(u);const g=n.makeTensorInfo(f,u.dtype,p);if(o){const m=an(f,i),w=Ht({inputs:{x:g},backend:n,attrs:{shape:m}});return n.disposeIntermediateTensorInfo(g),w}return g}const DE={kernelName:nh,backendName:"cpu",kernelFunc:AE};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function ga(e){const{inputs:t,backend:n,attrs:s}=e,{x:r}=t,{axis:a,keepDims:o}=s;ft(r,"sum");let i;r.dtype==="bool"?i=cs({inputs:{x:r},backend:n,attrs:{dtype:"int32"}}):i=kn({inputs:{x:r},backend:n});const l=i.shape.length,c=ae(a,i.shape),u=Nn(c,l);let f=c,h=i;u!=null&&(h=_e({inputs:{x:i},backend:n,attrs:{perm:u}}),f=In(f.length,l)),Hs("sum",f,h.shape.length);const[d,p]=qn(h.shape,f),y=Sr(h.dtype,"int32");let g=so(n,d,y);const m=nt(p),w=n.data.get(g.dataId).values,S=n.data.get(h.dataId).values;for(let k=0;k<w.length;++k){const I=k*m;let $=0;for(let E=0;E<m;++E)$+=S[I+E];w[k]=$}if(o){const k=an(g.shape,c),I=g;g=Ht({inputs:{x:g},backend:n,attrs:{shape:k}}),n.disposeIntermediateTensorInfo(I)}return n.disposeIntermediateTensorInfo(i),u!=null&&n.disposeIntermediateTensorInfo(h),g}const t3={kernelName:kd,backendName:"cpu",kernelFunc:ga};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function x3(e){const{inputs:t,backend:n,attrs:s}=e,{x:r,filter:a,bias:o,preluActivationWeights:i}=t,{strides:l,pad:c,dataFormat:u,dilations:f,dimRoundingMode:h,activation:d,leakyreluAlpha:p}=s;let y=Dm({inputs:{x:r,filter:a},backend:n,attrs:{strides:l,pad:c,dataFormat:u,dilations:f,dimRoundingMode:h}});if(o){const g=y;if(u==="NCHW"&&o.shape.length===1&&o.shape[0]!==1){const m=Ht({inputs:{x:o},backend:n,attrs:{shape:[o.shape[0],1,1]}});y=pr({inputs:{a:y,b:m},backend:n}),n.disposeIntermediateTensorInfo(m)}else y=pr({inputs:{a:y,b:o},backend:n});n.disposeIntermediateTensorInfo(g)}if(d){const g=y;if(u==="NCHW"&&d==="prelu"&&i.shape.length===1&&i.shape[0]!==1){const m=Ht({inputs:{x:i},backend:n,attrs:{shape:[i.shape[0],1,1]}});y=ao(n,y,d,m,p),n.disposeIntermediateTensorInfo(m)}else y=ao(n,y,d,i,p);n.disposeIntermediateTensorInfo(g)}return y}const N3={kernelName:Ni,backendName:"cpu",kernelFunc:x3};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function pA(e){const{inputs:t,backend:n,attrs:s}=e,{x:r}=t,{axis:a,keepDims:o}=s;ft(r,"min");const i=ae(a,r.shape);let l=i;const c=Nn(l,r.shape.length);let u=r;c!=null&&(u=_e({inputs:{x:r},backend:n,attrs:{perm:c}}),l=In(l.length,r.shape.length)),Hs("min",l,u.shape.length);const[f,h]=qn(u.shape,l),d=nt(h),p=fe(nt(f),u.dtype),y=n.data.get(u.dataId).values;for(let m=0;m<p.length;++m){const w=m*d;let S=y[w];for(let k=0;k<d;++k){const I=y[w+k];(Number.isNaN(I)||I<S)&&(S=I)}p[m]=S}c!=null&&n.disposeIntermediateTensorInfo(u);const g=n.makeTensorInfo(f,u.dtype,p);if(o){const m=an(f,i),w=Ht({inputs:{x:g},backend:n,attrs:{shape:m}});return n.disposeIntermediateTensorInfo(g),w}return g}const mA={kernelName:Gh,backendName:"cpu",kernelFunc:pA};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function bD(e){const{inputs:t,backend:n}=e,{condition:s,t:r,e:a}=t;ft([s,r,a],"select");const o=s.shape.length,i=n.data.get(s.dataId).values,l=n.data.get(r.dataId).values,c=n.data.get(a.dataId).values,u=Sr(r.dtype,a.dtype),f=fe(nt(r.shape),u);let h=0;const d=o===0||o>1||r.shape.length===1?1:nt(r.shape.slice(1));for(let p=0;p<i.length;p++)for(let y=0;y<d;y++)i[p]===1?f[h++]=l[p]:f[h++]=c[p];return n.makeTensorInfo(r.shape,u,f)}const wD={kernelName:bd,backendName:"cpu",kernelFunc:bD};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
