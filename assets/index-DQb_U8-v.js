 ...
 * limitations under the License.
 * =============================================================================
 */const _u=20,_r=3,ni=7;function lb(e,t,n,s){const r=yt(t),a=cb(e,t,n,r),o=t.length,i=Aa(e,t,n,r,a),l=["Tensor"];return s&&(l.push(`  dtype: ${n}`),l.push(`  rank: ${o}`),l.push(`  shape: [${t}]`),l.push("  values:")),l.push(i.map(c=>"    "+c).join(`
`)),l.join(`
`)}function cb(e,t,n,s){const r=nt(t),a=s[s.length-1],o=new Array(a).fill(0),i=t.length,l=n==="complex64"?Fr(e):e;if(i>1)for(let c=0;c<r/a;c++){const u=c*a;for(let f=0;f<a;f++)o[f]=Math.max(o[f],Or(l[u+f],0,n).length)}return o}function Or(e,t,n){let s;return Array.isArray(e)?s=`${parseFloat(e[0].toFixed(ni))} + ${parseFloat(e[1].toFixed(ni))}j`:No(e)?s=`'${e}'`:n==="bool"?s=qd(e):s=parseFloat(e.toFixed(ni)).toString(),Ea(s,t)}function qd(e){return e===0?"false":"true"}function Aa(e,t,n,s,r,a=!0){const o=n==="complex64"?2:1,i=t[0],l=t.length;if(l===0){if(n==="complex64"){const y=Fr(e);return[Or(y[0],0,n)]}return n==="bool"?[qd(e[0])]:[e[0].toString()]}if(l===1){if(i>_u){const g=_r*o;let m=Array.from(e.slice(0,g)),w=Array.from(e.slice((i-_r)*o,i*o));return n==="complex64"&&(m=Fr(m),w=Fr(w)),["["+m.map((S,k)=>Or(S,r[k],n)).join(", ")+", ..., "+w.map((S,k)=>Or(S,r[i-_r+k],n)).join(", ")+"]"]}return["["+(n==="complex64"?Fr(e):Array.from(e)).map((g,m)=>Or(g,r[m],n)).join(", ")+"]"]}const c=t.slice(1),u=s.slice(1),f=s[0]*o,h=[];if(i>_u){for(let y=0;y<_r;y++){const g=y*f,m=g+f;h.push(...Aa(e.slice(g,m),c,n,u,r,!1))}h.push("...");for(let y=i-_r;y<i;y++){const g=y*f,m=g+f;h.push(...Aa(e.slice(g,m),c,n,u,r,y===i-1))}}else for(let y=0;y<i;y++){const g=y*f,m=g+f;h.push(...Aa(e.slice(g,m),c,n,u,r,y===i-1))}const d=l===2?",":"";h[0]="["+(i>0?h[0]+d:"");for(let y=1;y<h.length-1;y++)h[y]=" "+h[y]+d;let p=`,
`;for(let y=2;y<l;y++)p+=`
`;return h[h.length-1]=" "+h[h.length-1]+"]"+(a?"":p),h}function Fr(e){const t=[];for(let n=0;n<e.length;n+=2)t.push([e[n],e[n+1]]);return t}/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */var Eu;(function(e){e.R0="R0",e.R1="R1",e.R2="R2",e.R3="R3",e.R4="R4",e.R5="R5",e.R6="R6"})(Eu||(Eu={}));var _i;(function(e){e.float32="float32",e.int32="int32",e.bool="int32",e.complex64="complex64"})(_i||(_i={}));var Ei;(function(e){e.float32="float32",e.int32="int32",e.bool="bool",e.complex64="complex64"})(Ei||(Ei={}));var Ci;(function(e){e.float32="float32",e.int32="float32",e.bool="float32",e.complex64="complex64"})(Ci||(Ci={}));var Ai;(function(e){e.float32="complex64",e.int32="complex64",e.bool="complex64",e.complex64="complex64"})(Ai||(Ai={}));const hb={float32:Ci,int32:_i,bool:Ei,complex64:Ai};function Sr(e,t){if(e==="string"||t==="string"){if(e==="string"&&t==="string")return"string";throw new Error(`Can not upcast ${e} with ${t}`)}return hb[e][t]}function Kd(e){return e!=null&&typeof e=="object"&&"texture"in e&&e.texture instanceof WebGLTexture}function Xd(e){return typeof GPUBuffer<"u"&&e!=null&&typeof e=="object"&&"buffer"in e&&e.buffer instanceof GPUBuffer}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Xt(e,t){if(e.dtype===t.dtype)return[e,t];const n=Sr(e.dtype,t.dtype);return[e.cast(n),t.cast(n)]}function db(e,t){T(e.dtype===t.dtype,()=>`The dtypes of the first(${e.dtype}) and second(${t.dtype}) input must match`)}function Yd(e){const t=[];return Zd(e,t,new Set),t}function Zd(e,t,n){if(e==null)return;if(e instanceof pe){t.push(e);return}if(!pb(e))return;const s=e;for(const r in s){const a=s[r];n.has(a)||(n.add(a),Zd(a,t,n))}}function pb(e){return Array.isArray(e)||typeof e=="object"}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const er="://";class he{constructor(){this.managers={}}static getInstance(){return he.instance==null&&(he.instance=new he),he.instance}static registerManager(t,n){T(t!=null,()=>"scheme must not be undefined or null."),t.endsWith(er)&&(t=t.slice(0,t.indexOf(er))),T(t.length>0,()=>"scheme must not be an empty string.");const s=he.getInstance();T(s.managers[t]==null,()=>`A model store manager is already registered for scheme '${t}'.`),s.managers[t]=n}static getManager(t){const n=he.getInstance().managers[t];if(n==null)throw new Error(`Cannot find model manager for scheme '${t}'`);return n}static getSchemes(){return Object.keys(he.getInstance().managers)}}function Da(e){if(e.indexOf(er)===-1)throw new Error(`The url string provided does not contain a scheme. Supported schemes are: ${he.getSchemes().join(",")}`);return{scheme:e.split(er)[0],path:e.split(er)[1]}}async function hp(e,t,n=!1){T(e!==t,()=>`Old path and new path are the same: '${e}'`);const s=Gt.getLoadHandlers(e);T(s.length>0,()=>`Copying failed because no load handler is found for source URL ${e}.`),T(s.length<2,()=>`Copying failed because more than one (${s.length}) load handlers for source URL ${e}.`);const r=s[0],a=Gt.getSaveHandlers(t);T(a.length>0,()=>`Copying failed because no save handler is found for destination URL ${t}.`),T(a.length<2,()=>`Copying failed because more than one (${s.length}) save handlers for destination URL ${t}.`);const o=a[0],i=Da(e).scheme,l=Da(e).path,c=i===Da(e).scheme,u=await r.load();n&&c&&await he.getManager(i).removeModel(l);const f=await o.save(u);return n&&!c&&await he.getManager(i).removeModel(l),f.modelArtifactsInfo}async function Yb(){const e=he.getSchemes(),t={};for(const n of e){const s=await he.getManager(n).listModels();for(const r in s){const a=n+er+r;t[a]=s[r]}}return t}async function Zb(e){const t=Da(e);return he.getManager(t.scheme).removeModel(t.path)}async function Jb(e,t){return hp(e,t,!1)}async function Qb(e,t){return hp(e,t,!0)}/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class t0{constructor(){this.messageName="setTimeoutCustom",this.functionRefs=[],this.handledMessageCount=0,this.hasEventListener=!1}fetch(t,n){return fetch(t,n)}now(){return performance.now()}encode(t,n){if(n!=="utf-8"&&n!=="utf8")throw new Error(`Browser's encoder only supports utf-8, but got ${n}`);return this.textEncoder==null&&(this.textEncoder=new TextEncoder),this.textEncoder.encode(t)}decode(t,n){return new TextDecoder(n).decode(t)}setTimeoutCustom(t,n){if(typeof window>"u"||!$t().getBool("USE_SETTIMEOUTCUSTOM")){setTimeout(t,n);return}this.functionRefs.push(t),setTimeout(()=>{window.postMessage({name:this.messageName,index:this.functionRefs.length-1},"*")},n),this.hasEventListener||(this.hasEventListener=!0,window.addEventListener("message",s=>{if(s.source===window&&s.data.name===this.messageName){s.stopPropagation();const r=this.functionRefs[s.data.index];r(),this.handledMessageCount++,this.handledMessageCount===this.functionRefs.length&&(this.functionRefs=[],this.handledMessageCount=0)}},!0))}isTypedArray(t){return Bd(t)}}if($t().get("IS_BROWSER")){$t().setPlatform("browser",new t0);try{he.registerManager(Fs.URL_SCHEME,new Xb)}catch{}try{he.registerManager(Os.URL_SCHEME,new Bb)}catch{}}/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function l0(e,t){let n=N(e,"a","div"),s=N(t,"b","div");if([n,s]=Xt(n,s),n.dtype==="int32"&&s.dtype==="int32")return pp(n,s);const r={a:n,b:s},a={};return O.runKernel(Ol,r,a)}const Ht=A({div_:l0});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function j0(e){const n={x:N(e,"x","sigmoid","float32")};return O.runKernel(mc,n)}const sr=A({sigmoid_:j0});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function K0(e,t,n,s,r,a){const o=N(e,"forgetBias","basicLSTMCell"),i=N(t,"lstmKernel","basicLSTMCell"),l=N(n,"lstmBias","basicLSTMCell"),c=N(s,"data","basicLSTMCell"),u=N(r,"c","basicLSTMCell"),f=N(a,"h","basicLSTMCell"),h=be([c,f],1),d=Mt(h,i),p=vt(d,l),y=p.shape[0],g=p.shape[1]/4,m=[y,g],w=Bt(p,[0,0],m),S=Bt(p,[0,g],m),k=Bt(p,[0,g*2],m),I=Bt(p,[0,g*3],m),$=vt(lt(sr(w),Mi(S)),lt(u,sr(vt(o,k)))),E=lt(Mi($),sr(I));return[$,E]}const X0=A({basicLSTMCell_:K0});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function nw(e,t){let n=N(e,"a","div"),s=N(t,"b","div");[n,s]=Xt(n,s);const r=Ht(n,s),a=Ve(r),o=kp(s,a);return as(o,a,r)}const sw=A({divNoNan_:nw});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function dw(e,t=null,n=!1){const r={x:N(e,"x","max")},a={reductionIndices:t,keepDims:n};return O.runKernel(Wh,r,a)}const rr=A({max_:dw});/**
 * @license
 * Copyright 2020 Google Inc. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Yw(e){const t=N(e,"x","logSigmoid");return zn(s=>({value:gn(Ap(gn(s))),gradFunc:o=>lt(o,sr(gn(s)))}))(t)}const Zw=A({logSigmoid_:Yw});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function ek(e,t=null,n=!1){const s=N(e,"x","logSumExp"),r=ae(t,s.shape),a=rr(s,r,!0),o=Tt(s,a),i=Rs(o),l=qt(i,r),c=na(l),u=vt(X(a,c.shape),c);if(n){const f=an(u.shape,r);return X(u,f)}return u}const Dp=A({logSumExp_:ek});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function hr(e,t="float32"){if(ze(e),t==="complex64"){const s=hr(e,"float32"),r=hr(e,"float32");return is(s,r)}const n=ue(nt(e),t);return O.makeTensor(n,e,t)}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function $s(e,t="float32"){if(ze(e),t==="complex64"){const s=$s(e,"float32"),r=hr(e,"float32");return is(s,r)}const n=bl(nt(e),t);return O.makeTensor(n,e,t)}/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function gk(e,t,{indexing:n="xy"}={}){if(n!=="xy"&&n!=="ij")throw new TypeError(`${n} is not a valid third argument to meshgrid`);if(e===void 0)return[];let s=N(e,"x","meshgrid",e instanceof pe?e.dtype:"float32");if(t===void 0)return[s];let r=N(t,"y","meshgrid",t instanceof pe?t.dtype:"float32");const a=nt(s.shape),o=nt(r.shape);return n==="xy"?(s=X(s,[1,-1]),r=X(r,[-1,1]),[Mt($s([o,1],s.dtype),s),Mt(r,$s([1,a],r.dtype))]):(s=X(s,[-1,1]),r=X(r,[1,-1]),[Mt(s,$s([1,o],s.dtype)),Mt($s([a,1],r.dtype),r)])}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ue(e,t){kr(e);const n=fs(e,t);if(n.length!==1)throw new Error("tensor1d() requires values to be a flat/TypedArray");return hs(e,null,n,t)}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Br(e,t,n){if(kr(e),t!=null&&t.length!==2)throw new Error("tensor2d() requires shape to have two numbers");const s=fs(e,n);if(s.length!==2&&s.length!==1)throw new Error("tensor2d() requires values to be number[][] or flat/TypedArray");if(s.length===1&&t==null)throw new Error("tensor2d() requires shape to be provided when `values` are a flat/TypedArray");return hs(e,t,s,n)}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function qp(e,t,n){if(kr(e),t!=null&&t.length!==3)throw new Error("tensor3d() requires shape to have three numbers");const s=fs(e,n);if(s.length!==3&&s.length!==1)throw new Error("tensor3d() requires values to be number[][][] or flat/TypedArray");if(s.length===1&&t==null)throw new Error("tensor3d() requires shape to be provided when `values` are a flat array");return hs(e,t,s,n)}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function DS(e,t,n){if(kr(e),t!=null&&t.length!==4)throw new Error("tensor4d() requires shape to have four numbers");const s=fs(e,n);if(s.length!==4&&s.length!==1)throw new Error("tensor4d() requires values to be number[][][][] or flat/TypedArray");if(s.length===1&&t==null)throw new Error("tensor4d() requires shape to be provided when `values` are a flat array");return hs(e,t,s,n)}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function OS(e,t,n){if(kr(e),t!=null&&t.length!==5)throw new Error("tensor5d() requires shape to have five numbers");const s=fs(e,n);if(s.length!==5&&s.length!==1)throw new Error("tensor5d() requires values to be number[][][][][] or flat/TypedArray");if(s.length===1&&t==null)throw new Error("tensor5d() requires shape to be provided when `values` are a flat array");return hs(e,t,s,n)}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function QS(e,t,n,s,r=!0){const a=N(e,"v","movingAverage"),o=N(t,"x","movingAverage"),i=N(n,"decay","movingAverage");db(a,o),T(Ke(a.shape,o.shape),()=>"Shape mismatch in v and x");const l=At(1),c=Tt(l,i);let u=lt(Tt(o,a),c);if(r){T(s!=null,()=>"When using zeroDebias: true, step is required.");const f=N(s,"step","movingAverage");u=Ht(u,Tt(l,ea(i,f)))}return vt(a,u)}const tx=A({movingAverage_:QS});/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function cx(e,t,n,s){const r=N(e,"x","dropout");if(T(r.dtype==="float32",()=>`x has to be a floating point tensor since it's going to be scaled, but got a ${r.dtype} tensor instead.`),T(t>=0&&t<1,()=>`rate must be a float in the range [0, 1), but got ${t}.`),t===0)return e instanceof pe?r.clone():r;const a=lx(r,n),o=1-t,i=Ht(Tp(vt(Oc(a,0,1,"float32",s),o)),o);return lt(r,i)}const ux=A({dropout_:cx});/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Lc(e,t,n){if(n==null||n==="linear")return e;if(n==="relu")return lt(e,jp(t));throw new Error(`Cannot compute gradient for fused activation ${n}.`)}function zc(e,t){let n=t;const s=J1(e.shape,t.shape);return s.length>0&&(n=qt(n,s)),X(n,e.shape)}function Bc(e,t,n,s){if(t==="linear")return e;if(t==="relu")return Po(e);if(t==="elu")return vp(e);if(t==="relu6")return Bp(e);if(t==="prelu")return Lp(e,n);if(t==="leakyrelu")return Ep(e,s);if(t==="sigmoid")return sr(e);throw new Error(`Unknown fused activation ${t}.`)}const Wc=(e,t)=>!(e>0)||t==="linear";/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Jx(e,t,n,s=.5,r=Number.NEGATIVE_INFINITY,a=0){const o=N(e,"boxes","nonMaxSuppression"),i=N(t,"scores","nonMaxSuppression"),l=Nr(o,i,n,s,r,a);n=l.maxOutputSize,s=l.iouThreshold,r=l.scoreThreshold,a=l.softNmsSigma;const c={boxes:o,scores:i},u={maxOutputSize:n,iouThreshold:s,scoreThreshold:r,softNmsSigma:a},f=O.runKernel(Qh,c,u);return{selectedIndices:f[0],selectedScores:f[1]}}const Qx=A({nonMaxSuppressionWithScore_:Jx});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */var Ne;(function(e){e[e.NONE=0]="NONE",e[e.MEAN=1]="MEAN",e[e.SUM=2]="SUM",e[e.SUM_BY_NONZERO_WEIGHTS=3]="SUM_BY_NONZERO_WEIGHTS"})(Ne||(Ne={}));function vN(e,t,n=Ne.SUM_BY_NONZERO_WEIGHTS){const s=N(e,"losses","computeWeightedLoss");let r=null;t!=null&&(r=N(t,"weights","computeWeightedLoss"));const a=r==null?s:lt(s,r);if(n===Ne.NONE)return a;if(n===Ne.SUM)return qt(a);if(n===Ne.MEAN){if(r==null)return Ja(a);{const o=s.size/r.size,i=Ht(qt(a),qt(r));return o>1?Ht(i,At(o)):i}}if(n===Ne.SUM_BY_NONZERO_WEIGHTS){if(r==null)return Ht(qt(a),At(s.size));{const o=lt(r,$s(s.shape)),i=Zt(qt(Mp(o,At(0))),"float32");return Ht(qt(a),i)}}throw Error(`Unknown reduction: ${n}`)}const Gn=A({computeWeightedLoss_:vN});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function He(e,t,n=""){if(!(typeof e=="number"||typeof t=="number")){T(e.length===t.length,()=>n+` Shapes ${e} and ${t} must match`);for(let s=0;s<e.length;s++){const r=e[s],a=t[s];T(r<0||a<0||r===a,()=>n+` Shapes ${e} and ${t} must match`)}}}function sf(e){return!(typeof e=="number"||e.some(t=>t<0))}function Er(e,t,n){let s=Qi(e,n);const r=!sf(s);if(r&&t.length===0)throw new Error(`Tried to calculate elements of an empty list with non-fully-defined elementShape: ${s}`);if(r&&t.forEach(a=>{s=Qi(a.shape,s)}),!sf(s))throw new Error(`Non-fully-defined elementShape: ${s}`);return s}function Qi(e,t){if(typeof e=="number")return t;if(typeof t=="number")return e;if(e.length!==t.length)throw new Error(`Incompatible ranks during merge: ${e} vs. ${t}`);const n=[];for(let s=0;s<e.length;++s){const r=e[s],a=t[s];if(r>=0&&a>=0&&r!==a)throw new Error(`Incompatible shape during merge: ${e} vs. ${t}`);n[s]=r>=0?r:a}return n}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function so(e,t,n="float32"){if(n==="complex64"){const r=so(e,t,"float32"),a=so(e,t,"float32");return Re({inputs:{real:r,imag:a},backend:e})}const s=ue(nt(t),n);return e.makeTensorInfo(t,n,s)}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const S$=Jt(((e,t)=>e+t)),x$=Gc(((e,t,n,s)=>({real:e+n,imag:t+s}))),pr=se(Io,S$,x$),N$={kernelName:Io,backendName:"cpu",kernelFunc:pr};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function o_(e,t,n){const s=(t-e)/(n-1),r=ue(n,"float32");r[0]=e;for(let a=1;a<r.length;a++)r[a]=r[a-1]+s;return r}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function km(e,t,n,s,r){const a=t.length,o=nt(t),i=yt(t),l=yt(r),c=ke(n,nt(r));for(let u=0;u<o;++u){const f=vr(u,a,i),h=new Array(f.length);for(let p=0;p<h.length;p++)h[p]=f[s[p]];const d=pn(h,a,l);c[d]=e[u]}return c}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function T_(e,t,n,s){const[r,a]=qn(e,s),o=Sr(t,"int32"),i=ue(nt(r),o),l=nt(a);for(let c=0;c<i.length;++c){const u=c*l;let f=1;for(let h=0;h<l;++h)f*=n[u+h];i[c]=f}return{outVals:i,outShape:r,outDtype:o}}function $_(e){const{inputs:t,backend:n,attrs:s}=e,{x:r}=t,{axis:a,keepDims:o}=s;ft(r,"prod");const i=r.shape.length,l=ae(a,r.shape),c=Nn(l,i);let u=l,f=r;const h=[];c!=null&&(f=_e({inputs:{x:r},backend:n,attrs:{perm:c}}),h.push(f),u=In(u.length,i));const d=n.data.get(f.dataId).values,{outVals:p,outShape:y,outDtype:g}=T_(f.shape,f.dtype,d,u);let m=y;return o&&(m=an(y,l)),h.forEach(w=>n.disposeIntermediateTensorInfo(w)),n.makeTensorInfo(m,g,p)}const __={kernelName:ad,backendName:"cpu",kernelFunc:$_};/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function V_(e,t,n,s){const r=e===t,a=e<t&&n<0,o=t<e&&n>1;if(r||a||o)return ue(0,s);const i=Math.abs(Math.ceil((t-e)/n)),l=ue(i,s);t<e&&n===1&&(n=-1),l[0]=e;for(let c=1;c<l.length;c++)l[c]=l[c-1]+n;return l}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Rr=(e,t)=>{const n=t.value-e.value;return n===0?e.index-t.index:n};function xm(e,t,n=0,s=e.length-1){for(;s>n;){if(s-n>600){const i=s-n+1,l=t-n+1,c=Math.log(i),u=.5*Math.exp(2*c/3),f=.5*Math.sqrt(c*u*(i-u)/i)*Math.sign(l-i/2),h=Math.max(n,Math.floor(t-l*u/i+f)),d=Math.min(s,Math.floor(t+(i-l)*u/i+f));xm(e,t,h,d)}const r=e[t];let a=n,o=s;for($r(e,n,t),Rr(e[s],r)>0&&$r(e,n,s);a<o;){for($r(e,a,o),a++,o--;Rr(e[a],r)<0;)a=a+1;for(;Rr(e[o],r)>0;)o=o-1}Rr(e[n],r)===0?$r(e,n,o):(o=o+1,$r(e,o,s)),o<=t&&(n=o+1),t<=o&&(s=o-1)}}function fE(e,t,n,s,r){const a=t[t.length-1],[o,i]=[e.length/a,a],l=ke(n,o*s),c=ke("int32",o*s);for(let f=0;f<o;f++){const h=f*i,d=e.subarray(h,h+i);let p=new Array(d.length);d.forEach((w,S)=>p[S]={value:w,index:S}),s<p.length&&(xm(p,s),p=p.slice(0,s)),r&&p.sort(Rr);const y=f*s,g=l.subarray(y,y+s),m=c.subarray(y,y+s);for(let w=0;w<s;w++)g[w]=p[w].value,m[w]=p[w].index}const u=t.slice();return u[u.length-1]=s,[Et(u,n,l),Et(u,"int32",c)]}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Em(e){const{inputs:t,backend:n,attrs:s}=e,{a:r,b:a}=t,{transposeA:o,transposeB:i}=s;ft([r,a],"matMul");const l=r.shape.length,c=a.shape.length,u=o?r.shape[l-2]:r.shape[l-1],f=i?a.shape[c-1]:a.shape[c-2],h=o?r.shape[l-1]:r.shape[l-2],d=i?a.shape[c-2]:a.shape[c-1],p=r.shape.slice(0,-2),y=a.shape.slice(0,-2),g=nt(p),m=nt(y),S=Yt(r.shape.slice(0,-2),a.shape.slice(0,-2)).concat([h,d]);T(u===f,()=>`Error in matMul: inner shapes (${u}) and (${f}) of Tensors with shapes ${r.shape} and ${a.shape} and transposeA=${o} and transposeB=${i} must match.`);const k=o?[g,u,h]:[g,h,u],I=i?[m,d,f]:[m,f,d],$=Ut({inputs:{x:r},backend:n,attrs:{shape:k}}),E=Ut({inputs:{x:a},backend:n,attrs:{shape:I}}),D=o?$.shape[1]:$.shape[2],_=o?$.shape[2]:$.shape[1],x=i?E.shape[1]:E.shape[2],v=Math.max(g,m),R=n.data.get($.dataId).values,P=n.data.get(E.dataId).values,V=yt($.shape),M=yt(E.shape),[L,W,z]=o?[V[0],1,V[1]]:[V[0],V[1],1],[H,K,Y]=i?[1,M[1],M[0]]:[M[1],1,M[0]],Z=_*x,Q=Et([v,_,x],$.dtype),ot=Q.values,at=n.blockSize;for(let ct=0;ct<v;ct++){const dt=ct%g,mt=ct%m;for(let pt=0;pt<_;pt+=at){const kt=Math.min(pt+at,_);for(let It=0;It<x;It+=at){const C=Math.min(It+at,x);for(let F=0;F<D;F+=at){const B=Math.min(F+at,D);for(let q=pt;q<kt;q++)for(let U=It;U<C;U++){let G=0;for(let et=F;et<B;et++){const rt=R[dt*L+q*W+et*z],tt=P[et*H+U*K+mt*Y];G+=rt*tt}ot[ct*Z+(q*x+U)]+=G}}}}}return n.disposeIntermediateTensorInfo($),n.disposeIntermediateTensorInfo(E),n.makeTensorInfo(S,Q.dtype,Q.values)}const kE={kernelName:ih,backendName:"cpu",kernelFunc:Em};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function EE(e){const{inputs:t,backend:n,attrs:s}=e,{x:r}=t,{axis:a,keepDims:o}=s;ft(r,"all");const i=ae(a,r.shape);let l=i;const c=Nn(l,r.shape.length);let u=r;c!=null&&(u=_e({inputs:{x:r},backend:n,attrs:{perm:c}}),l=In(l.length,r.shape.length)),Us("all",l,u.shape.length);const[f,h]=qn(u.shape,l),d=nt(h),p=ue(nt(f),u.dtype),y=n.data.get(u.dataId).values;for(let m=0;m<p.length;++m){const w=m*d;let S=y[w];for(let k=0;k<d;++k){const I=y[w+k];S=S&&I}p[m]=S}c!=null&&n.disposeIntermediateTensorInfo(u);const g=n.makeTensorInfo(f,u.dtype,p);if(o){const m=an(f,i),w=Ut({inputs:{x:g},backend:n,attrs:{shape:m}});return n.disposeIntermediateTensorInfo(g),w}return g}const CE={kernelName:eh,backendName:"cpu",kernelFunc:EE};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function AE(e){const{inputs:t,backend:n,attrs:s}=e,{x:r}=t,{axis:a,keepDims:o}=s;ft(r,"any");const i=ae(a,r.shape);let l=i;const c=Nn(l,r.shape.length);let u=r;c!=null&&(u=_e({inputs:{x:r},backend:n,attrs:{perm:c}}),l=In(l.length,r.shape.length)),Us("any",l,u.shape.length);const[f,h]=qn(u.shape,l),d=nt(h),p=ue(nt(f),u.dtype),y=n.data.get(u.dataId).values;for(let m=0;m<p.length;++m){const w=m*d;let S=y[w];for(let k=0;k<d;++k){const I=y[w+k];S=S||I}p[m]=S}c!=null&&n.disposeIntermediateTensorInfo(u);const g=n.makeTensorInfo(f,u.dtype,p);if(o){const m=an(f,i),w=Ut({inputs:{x:g},backend:n,attrs:{shape:m}});return n.disposeIntermediateTensorInfo(g),w}return g}const DE={kernelName:nh,backendName:"cpu",kernelFunc:AE};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function XE(e){const{inputs:t,backend:n,attrs:s}=e,{x:r}=t;ft(r,"avgPool");const{filterSize:a,strides:o,pad:i,dimRoundingMode:l}=s,c=1;T(sn(o,c),()=>`Error in avgPool: Either strides or dilations must be 1. Got strides ${o} and dilations '${c}'`);const u=xr(r.shape,a,o,c,i,l);let f;if(u.filterWidth===1&&u.filterHeight===1&&Ke(u.inShape,u.outShape))f=kn({inputs:{x:r},backend:n});else{const h=n.data.get(r.dataId).values,d=yt(r.shape),p=Xc(h,r.shape,r.dtype,d,u,"avg");f=n.makeTensorInfo(u.outShape,r.dtype,p.values)}return f}const YE={kernelName:ah,backendName:"cpu",kernelFunc:XE};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function aC(e){const{inputs:t,backend:n,attrs:s}=e,{x:r}=t,{blockShape:a,crops:o}=s;ft([r],"batchToSpaceND");const i=a.reduce((m,w)=>m*w),l=cm(r.shape,a,i),c=um(l.length,a.length),u=fm(r.shape,a,i),f=eT(o,a.length),h=nT(u,o,a.length),d=Ut({inputs:{x:r},backend:n,attrs:{shape:l}}),p=_e({inputs:{x:d},backend:n,attrs:{perm:c}}),y=Ut({inputs:{x:p},backend:n,attrs:{shape:u}}),g=zs({inputs:{x:y},backend:n,attrs:{begin:f,size:h}});return n.disposeIntermediateTensorInfo(d),n.disposeIntermediateTensorInfo(p),n.disposeIntermediateTensorInfo(y),g}const oC={kernelName:lh,backendName:"cpu",kernelFunc:aC};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function mr(e){const{inputs:t,backend:n}=e,{input:s}=t,r=n.data.get(s.dataId).complexTensorInfos.imag,a=n.data.get(r.dataId).values;return n.makeTensorInfo(r.shape,r.dtype,a)}const mC={kernelName:Vh,backendName:"cpu",kernelFunc:mr};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function gr(e){const{inputs:t,backend:n,attrs:s}=e,{axis:r}=s,a=ae(r,t[0].shape)[0],o=t.map(y=>y.shape);XI(o,a);let i=ii(t.map(y=>y.shape),a);if(nt(i)===0)return n.makeTensorInfo(i,t[0].dtype,[]);const l=t.filter(y=>nt(y.shape)>0);if(l.length===1)return kn({inputs:{x:l[0]},backend:n});if(l[0].dtype==="complex64"){const y=l.map(k=>Ls({inputs:{input:k},backend:n})),g=l.map(k=>mr({inputs:{input:k},backend:n})),m=gr({inputs:y,backend:n,attrs:{axis:a}}),w=gr({inputs:g,backend:n,attrs:{axis:a}}),S=Re({inputs:{real:m,imag:w},backend:n});return y.forEach(k=>n.disposeIntermediateTensorInfo(k)),g.forEach(k=>n.disposeIntermediateTensorInfo(k)),n.disposeIntermediateTensorInfo(m),n.disposeIntermediateTensorInfo(w),S}const c=l.map(y=>{const m=[-1,nt(y.shape.slice(a))];return Ut({inputs:{x:y},backend:n,attrs:{shape:m}})}),u=c.map(y=>({vals:n.data.get(y.dataId).values,shape:y.shape}));i=ii(c.map(y=>y.shape),1);const f=c[0].shape[0]===1,h=D$(u,i,t[0].dtype,f),d=ii(l.map(y=>y.shape),a),p=n.makeTensorInfo(d,t[0].dtype,h);return c.forEach(y=>n.disposeIntermediateTensorInfo(y)),p}const gC={kernelName:dh,backendName:"cpu",kernelFunc:gr};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function ga(e){const{inputs:t,backend:n,attrs:s}=e,{x:r}=t,{axis:a,keepDims:o}=s;ft(r,"sum");let i;r.dtype==="bool"?i=cs({inputs:{x:r},backend:n,attrs:{dtype:"int32"}}):i=kn({inputs:{x:r},backend:n});const l=i.shape.length,c=ae(a,i.shape),u=Nn(c,l);let f=c,h=i;u!=null&&(h=_e({inputs:{x:i},backend:n,attrs:{perm:u}}),f=In(f.length,l)),Us("sum",f,h.shape.length);const[d,p]=qn(h.shape,f),y=Sr(h.dtype,"int32");let g=so(n,d,y);const m=nt(p),w=n.data.get(g.dataId).values,S=n.data.get(h.dataId).values;for(let k=0;k<w.length;++k){const I=k*m;let $=0;for(let E=0;E<m;++E)$+=S[I+E];w[k]=$}if(o){const k=an(g.shape,c),I=g;g=Ut({inputs:{x:g},backend:n,attrs:{shape:k}}),n.disposeIntermediateTensorInfo(I)}return n.disposeIntermediateTensorInfo(i),u!=null&&n.disposeIntermediateTensorInfo(h),g}const t3={kernelName:kd,backendName:"cpu",kernelFunc:ga};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function oo(e){const{inputs:t,backend:n,attrs:s}=e,{input:r}=t,{dim:a}=s,o=r.shape.length,i=r.shape.slice();let l=a;return a<0&&(T(-(o+1)<=a,()=>`Axis must be in the interval [${-(o+1)}, ${o}]`),l=o+a+1),i.splice(l,0,1),Ut({inputs:{x:r},backend:n,attrs:{shape:i}})}const d3={kernelName:Ch,backendName:"cpu",kernelFunc:oo};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function b3(e){const{inputs:t,backend:n}=e,{input:s}=t,r=nt(s.shape),a=s.shape[s.shape.length-1],o=r/a,i=Ut({inputs:{x:s},backend:n,attrs:{shape:[o,a]}}),l=Fm(i,!1,n),c=Ut({inputs:{x:l},backend:n,attrs:{shape:s.shape}});return n.disposeIntermediateTensorInfo(i),n.disposeIntermediateTensorInfo(l),c}const w3={kernelName:Ah,backendName:"cpu",kernelFunc:b3};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function x3(e){const{inputs:t,backend:n,attrs:s}=e,{x:r,filter:a,bias:o,preluActivationWeights:i}=t,{strides:l,pad:c,dataFormat:u,dilations:f,dimRoundingMode:h,activation:d,leakyreluAlpha:p}=s;let y=Dm({inputs:{x:r,filter:a},backend:n,attrs:{strides:l,pad:c,dataFormat:u,dilations:f,dimRoundingMode:h}});if(o){const g=y;if(u==="NCHW"&&o.shape.length===1&&o.shape[0]!==1){const m=Ut({inputs:{x:o},backend:n,attrs:{shape:[o.shape[0],1,1]}});y=pr({inputs:{a:y,b:m},backend:n}),n.disposeIntermediateTensorInfo(m)}else y=pr({inputs:{a:y,b:o},backend:n});n.disposeIntermediateTensorInfo(g)}if(d){const g=y;if(u==="NCHW"&&d==="prelu"&&i.shape.length===1&&i.shape[0]!==1){const m=Ut({inputs:{x:i},backend:n,attrs:{shape:[i.shape[0],1,1]}});y=ao(n,y,d,m,p),n.disposeIntermediateTensorInfo(m)}else y=ao(n,y,d,i,p);n.disposeIntermediateTensorInfo(g)}return y}const N3={kernelName:Ni,backendName:"cpu",kernelFunc:x3};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function E3(e){const{inputs:t,backend:n,attrs:s}=e,{x:r,indices:a}=t,{axis:o,batchDims:i}=s;ft([r,a],"gatherV2");const l=ae(o,r.shape)[0],c=n.data.get(a.dataId).values,u=r.shape[l];for(let k=0;k<c.length;++k){const I=c[k];T(I<=u-1&&I>=0,()=>`GatherV2: the index value ${I} is not in [0, ${u-1}]`)}let f=i;i==null&&(f=0);const h=nt(a.shape),d=PT(r,a,l,f),p=Ut({inputs:{x:r},backend:n,attrs:{shape:[d.batchSize,d.outerSize,d.dimSize,d.sliceSize]}}),y=Ut({inputs:{x:a},backend:n,attrs:{shape:[d.batchSize,h/d.batchSize]}}),g=[d.batchSize,d.outerSize,h/d.batchSize,d.sliceSize],m=n.bufferSync(y),w=n.bufferSync(p),S=G$(w,m,g);return n.disposeIntermediateTensorInfo(p),n.disposeIntermediateTensorInfo(y),n.makeTensorInfo(d.outputShape,S.dtype,S.values)}const C3={kernelName:Rh,backendName:"cpu",kernelFunc:E3};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function A3(e){const{inputs:t,backend:n}=e,{input:s}=t,r=nt(s.shape),a=s.shape[s.shape.length-1],o=r/a,i=Ut({inputs:{x:s},backend:n,attrs:{shape:[o,a]}}),l=Fm(i,!0,n),c=Ut({inputs:{x:l},backend:n,attrs:{shape:s.shape}});return n.disposeIntermediateTensorInfo(i),n.disposeIntermediateTensorInfo(l),c}const D3={kernelName:Mh,backendName:"cpu",kernelFunc:A3};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function nA(e){const{inputs:t,backend:n,attrs:s}=e,{x:r}=t;ft(r,"maxPool");const{filterSize:a,strides:o,pad:i,dimRoundingMode:l}=s,c=1;T(sn(o,c),()=>`Error in maxPool: Either strides or dilations must be 1. Got strides ${o} and dilations '${c}'`);const u=xr(r.shape,a,o,c,i,l);let f;if(u.filterWidth===1&&u.filterHeight===1&&Ke(u.inShape,u.outShape))f=kn({inputs:{x:r},backend:n});else{const h=n.data.get(r.dataId).values,d=yt(r.shape),p=Xc(h,r.shape,r.dtype,d,u,"max");f=n.makeTensorInfo(u.outShape,r.dtype,p.values)}return f}const sA={kernelName:Hh,backendName:"cpu",kernelFunc:nA};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const fA={kernelName:jh,backendName:"cpu",kernelFunc:({inputs:e,attrs:t,backend:n})=>{const{x:s}=e,{filterSize:r,strides:a,pad:o,includeBatchInIndex:i}=t,l=n;ft(s,"MaxPoolWithArgmax");const c=l.data.get(s.dataId).values,u=xr(s.shape,r,a,[1,1],o),[f,h]=uA(c,s.shape,s.dtype,i,u),d=l.write(f,u.outShape,s.dtype),p=l.write(h,u.outShape,s.dtype);return[{dataId:d,shape:u.outShape,dtype:s.dtype},{dataId:p,shape:u.outShape,dtype:"int32"}]}};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function pA(e){const{inputs:t,backend:n,attrs:s}=e,{x:r}=t,{axis:a,keepDims:o}=s;ft(r,"min");const i=ae(a,r.shape);let l=i;const c=Nn(l,r.shape.length);let u=r;c!=null&&(u=_e({inputs:{x:r},backend:n,attrs:{perm:c}}),l=In(l.length,r.shape.length)),Us("min",l,u.shape.length);const[f,h]=qn(u.shape,l),d=nt(h),p=ue(nt(f),u.dtype),y=n.data.get(u.dataId).values;for(let m=0;m<p.length;++m){const w=m*d;let S=y[w];for(let k=0;k<d;++k){const I=y[w+k];(Number.isNaN(I)||I<S)&&(S=I)}p[m]=S}c!=null&&n.disposeIntermediateTensorInfo(u);const g=n.makeTensorInfo(f,u.dtype,p);if(o){const m=an(f,i),w=Ut({inputs:{x:g},backend:n,attrs:{shape:m}});return n.disposeIntermediateTensorInfo(g),w}return g}const mA={kernelName:Gh,backendName:"cpu",kernelFunc:pA};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function SA(e){const{inputs:t,backend:n,attrs:s}=e,{logits:r}=t,{numSamples:a,seed:o,normalized:i}=s;ft(r,"multinomial");const l=i?r:Pm({inputs:{logits:r},backend:n,attrs:{dim:-1}}),c=l.shape[0],u=l.shape[1],f=n.data.get(l.dataId).values,h=[c,a],d=ue(nt(h),"int32");for(let p=0;p<c;++p){const y=p*u,g=new Float32Array(u-1);g[0]=f[y];for(let S=1;S<g.length;++S)g[S]=g[S-1]+f[y+S];const m=Ro.alea(o.toString()),w=p*a;for(let S=0;S<a;++S){const k=m();d[w+S]=g.length;for(let I=0;I<g.length;I++)if(k<g[I]){d[w+S]=I;break}}}return i||n.disposeIntermediateTensorInfo(l),n.makeTensorInfo(h,"int32",d)}const xA={kernelName:Xh,backendName:"cpu",kernelFunc:SA};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function io(e){const{inputs:t,backend:n}=e,{x:s}=t;if(s.dtype==="string")throw new Error("zerosLike is not supported for string tensors");if(s.dtype==="complex64"){const r=Ls({inputs:{input:s},backend:n}),a=io({inputs:{x:r},backend:n}),o=mr({inputs:{input:s},backend:n}),i=io({inputs:{x:o},backend:n}),l=Re({inputs:{real:a,imag:i},backend:n});return n.disposeIntermediateTensorInfo(r),n.disposeIntermediateTensorInfo(a),n.disposeIntermediateTensorInfo(o),n.disposeIntermediateTensorInfo(i),l}else return Zc({backend:n,attrs:{shape:s.shape,value:0,dtype:s.dtype}})}const RA={kernelName:Vd,backendName:"cpu",kernelFunc:io};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Mm(e){const{inputs:t,backend:n}=e,{x:s}=t;if(s.dtype==="string")throw new Error("onesLike is not supported for string tensors");if(s.dtype==="complex64"){const r=Ls({inputs:{input:s},backend:n}),a=Mm({inputs:{x:r},backend:n}),o=mr({inputs:{input:s},backend:n}),i=io({inputs:{x:o},backend:n}),l=Re({inputs:{real:a,imag:i},backend:n});return n.disposeIntermediateTensorInfo(r),n.disposeIntermediateTensorInfo(a),n.disposeIntermediateTensorInfo(o),n.disposeIntermediateTensorInfo(i),l}else return Zc({backend:n,attrs:{shape:s.shape,value:1,dtype:s.dtype}})}const PA={kernelName:td,backendName:"cpu",kernelFunc:Mm};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function bD(e){const{inputs:t,backend:n}=e,{condition:s,t:r,e:a}=t;ft([s,r,a],"select");const o=s.shape.length,i=n.data.get(s.dataId).values,l=n.data.get(r.dataId).values,c=n.data.get(a.dataId).values,u=Sr(r.dtype,a.dtype),f=ue(nt(r.shape),u);let h=0;const d=o===0||o>1||r.shape.length===1?1:nt(r.shape.slice(1));for(let p=0;p<i.length;p++)for(let y=0;y<d;y++)i[p]===1?f[h++]=l[p]:f[h++]=c[p];return n.makeTensorInfo(r.shape,u,f)}const wD={kernelName:bd,backendName:"cpu",kernelFunc:bD};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function OD(e){const{inputs:t,backend:n,attrs:s}=e,{x:r}=t,{blockShape:a,paddings:o}=s;ft([r],"spaceToBatchND");const i=nt(a),l=[[0,0]];l.push(...o);for(let $=1+a.length;$<r.shape.length;++$)l.push([0,0]);const c=Lm.kernelFunc({inputs:{x:r},backend:n,attrs:{paddings:l,constantValue:0}}),u=cm(c.shape,a,i,!1),f=um(u.length,a.length,!1),h=fm(c.shape,a,i,!1),y=Ut({inputs:{x:c},backend:n,attrs:{shape:u}}),w=_e({inputs:{x:y},backend:n,attrs:{perm:f}}),I=Ut({inputs:{x:w},backend:n,attrs:{shape:h}});return n.disposeIntermediateTensorInfo(c),n.disposeIntermediateTensorInfo(y),n.disposeIntermediateTensorInfo(w),I}const FD={kernelName:vd,backendName:"cpu",kernelFunc:OD};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function HD(e){const{inputs:t,backend:n,attrs:s}=e,{sparseIndices:r,sparseValues:a,defaultValue:o}=t,{outputShape:i}=s,{sliceRank:l,numUpdates:c,sliceSize:u,strides:f,outputSize:h}=Mc(a,r,i),d=!1,p=n.bufferSync(r);let y;switch(a.dtype){case"bool":{const g=n.bufferSync(a),m=!!n.data.get(o.dataId).values[0];y=tr(p,g,i,h,u,c,l,f,m,d);break}case"float32":{const g=n.bufferSync(a),m=n.data.get(o.dataId).values[0];y=tr(p,g,i,h,u,c,l,f,m,d);break}case"int32":{const g=n.bufferSync(a),m=n.data.get(o.dataId).values[0];y=tr(p,g,i,h,u,c,l,f,m,d);break}case"string":{const g=n.bufferSync(a),m=Zr(n.data.get(o.dataId).values[0]);y=tr(p,g,i,h,u,c,l,f,m,d);break}default:throw new Error(`Unsupported type ${a.dtype}`)}return n.makeTensorInfo(i,y.dtype,y.values)}const UD={kernelName:_d,backendName:"cpu",kernelFunc:HD};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function YD(e){const{inputs:t,backend:n,attrs:s}=e,{x:r}=t,{begin:a,end:o,strides:i,beginMask:l,endMask:c,ellipsisMask:u,newAxisMask:f,shrinkAxisMask:h}=s;ft(r,"stridedSlice");const{finalShapeSparse:d,finalShape:p,isIdentity:y,sliceDim0:g,isSimpleSlice:m,begin:w,end:S,strides:k}=GI(r.shape,a,o,i,l,c,u,f,h);let I;if(y)I=Ut({inputs:{x:r},backend:n,attrs:{shape:p}});else if(g||m){T(r.shape.length>=1,()=>`Input must have rank at least 1, got: ${r.shape.length}`);const $=HI(w,S,k),E=zs({inputs:{x:r},backend:n,attrs:{begin:w,size:$}});I=Ut({inputs:{x:E},backend:n,attrs:{shape:p}}),n.disposeIntermediateTensorInfo(E)}else{const $=n.bufferSync(r),E=eE(d,$,k,w);I=n.makeTensorInfo(p,E.dtype,E.values)}return I}const ZD={kernelName:Ed,backendName:"cpu",kernelFunc:YD};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function lO(e){const{inputs:t,backend:n}=e,{tensor:s,indices:r,updates:a}=t,{sliceRank:o,numUpdates:i,sliceSize:l,strides:c,outputSize:u}=Mc(a,r,s.shape),f=!1,h=n.bufferSync(r),d=n.bufferSync(a),p=n.bufferSync(s),y=tr(h,d,s.shape,u,l,i,o,c,p,f);return n.makeTensorInfo(s.shape,y.dtype,y.values)}const cO={kernelName:gd,backendName:"cpu",kernelFunc:lO};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function NO(e){const{inputs:t,backend:n,attrs:s}=e,{value:r}=t;let{axis:a}=s;a<0&&(a+=r.shape.length);const o=r.shape.length,i=r.shape[a],l=new Array(o-1);let c=0;for(let d=0;d<o;d++)d!==a&&(l[c++]=r.shape[d]);const u=new Array(o).fill(0),f=r.shape.slice();f[a]=1;const h=new Array(i);for(let d=0;d<h.length;d++){u[a]=d;const p=zs({inputs:{x:r},backend:n,attrs:{begin:u,size:f}});h[d]=Ut({inputs:{x:p},backend:n,attrs:{shape:l}}),n.disposeIntermediateTensorInfo(p)}return h}const IO={kernelName:Pd,backendName:"cpu",kernelFunc:NO};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
